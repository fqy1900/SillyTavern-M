...
console.log('index.html 大小:', indexHtml.length);

// chat.html 特有功能：返回按钮 + 自动角色选择脚本
...
console.log('  - 原始大小:', indexHtml.length);
console.log('  - 新大小:', newChatHtml.length);
