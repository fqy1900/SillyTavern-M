...
export async function openWelcomeScreen({ force = false, expand = false } = {}) {
    try {
        ...
        try {
            ...
            console.warn('sendAssistantMessage failed:', err);
        }
        try {
            sendWelcomePrompt();
        } catch (err) {
            console.warn('sendWelcomePrompt failed:', err);
        }
    } catch (err) {
        console.error('openWelcomeScreen error:', err);
    }
}
...
function sendAssistantMessage() {
    try {
        ...
        console.warn('sendAssistantMessage inner error:', err);
    }
}
...
function sendWelcomePrompt() {
    try {
        ...
        console.warn('sendWelcomePrompt inner error:', err);
    }
}
