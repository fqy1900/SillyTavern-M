...
export class ReasoningHandler {
    ...
    initHandleMessage(messageIdOrElement, { reset = false } = {}) {
        ...
        if (!messageElement) {
            console.warn('initHandleMessage: message element not found');
            return;
        }
        ...
        if (power_user.reasoning.auto_expand && this.state !== ReasoningState.Hidden && this.messageReasoningDetailsDom) {
    ...
    updateDom(messageId) {
        ...
        if (this.messageReasoningContentDom) {
        ...
        if (this.state === ReasoningState.Hidden && this.messageReasoningDetailsDom) {
    ...
    #checkDomElements(messageId) {
        ...
        if (this.messageDom === null) {
            ...
            if (this.messageDom === null) return;
        }
