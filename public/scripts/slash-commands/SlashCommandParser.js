...
// ⚠️ 循环依赖修复：power-user.js → SlashCommandParser.js → power-user.js
// power_user 仅在 class 方法中使用（非模块级），改为惰性 Proxy 绕过循环 import。
...
async function loadPowerUser() {
    ...
    try {
        ...
        console.warn('[SlashCommandParser] Failed to lazy-load power_user:', e);
    }
}
